...
class Fachada {
    ...
    public function __construct() {
        try {
            ...
            /* Luego de tener las variables globales del config.php se configura la ruta del log
             * La ruta del los sera TMP_PATH . logs/ 
             *              */
            ini_set('display_errors', 'On');
            ini_set('log_errors', 'On');
            ini_set('error_log', TMP_PATH . 'logs/log_siba.txt');
